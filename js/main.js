...
window.toggleScoreDetails = function(index) {
        ...
        c.innerHTML = `
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div class="relative z-10 flex flex-col md:flex-row items-center gap-6">
                        ...
                        <div class="flex-grow text-center md:text-left">
                            ...
                            <div class="mt-3 flex flex-wrap justify-center md:justify-start gap-3">
                                <div class="bg-indigo-500/20 border border-indigo-500/30 px-3 py-1.5 rounded-lg text-sm font-bold text-indigo-300">Global #${Utils.formatNumber(u.global_rank)}</div>
                ...
                <div class="stat-panel-clean col-span-1">
                    ...
                    <h4 class="text-lg font-bold text-white truncate">${Utils.formatNumber(u.ranked_score)}</h4>
                </div>
                <div class="stat-panel-clean col-span-1">
                ...
                <div class="stat-panel-clean col-span-1">
                    ...
                    <h4 class="text-lg font-bold text-white">${Utils.formatNumber(u.play_count)}</h4>
                </div>
                <div class="stat-panel-clean col-span-1">
                    <p class="text-[10px] text-gray-500 uppercase font-bold mb-1">Total Hits</p>
                    <h4 class="text-lg font-bold text-white">${Utils.formatNumber(u.total_hits)}</h4>
                </div>
                ...
                <div class="stat-panel-clean col-span-1">
                    ...
                    <h4 class="text-sm font-bold text-gray-300 break-all">${Utils.formatNumber(u.total_score)}</h4>
                </div>
                <div class="stat-panel-clean col-span-1">
                    <p class="text-[10px] text-gray-500 uppercase font-bold mb-1">Replays</p>
                    <h4 class="text-lg font-bold text-white">${Utils.formatNumber(u.replays_watched)}</h4>
                </div>
...
window.copyDiscord = function() { navigator.clipboard.writeText(".morgun.").then(()=>{ var t=document.getElementById("toast"); t.className="show"; setTimeout(()=>t.className=t.className.replace("show",""),3000); }); }
