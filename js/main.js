...
function toggleScoreDetails(index) { document.getElementById(`score-row-${index}`).classList.toggle('open'); }
...
async function loadUserStats() {
    ...
    try {
        ...
        c.innerHTML = `
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div class="profile-stats-grid col-span-2 md:col-span-4">
                    <div class="stat-panel-clean"><p class="text-[10px] text-gray-500 uppercase font-bold mb-1">Ranked Score</p><h4 class="text-base font-bold text-white truncate">${Utils.formatNumber(u.ranked_score)}</h4></div>
                    <div class="stat-panel-clean"><p class="text-[10px] text-gray-500 uppercase font-bold mb-1">Hit Accuracy</p><h4 class="text-base font-bold text-white">${u.accuracy}%</h4></div>
                    <div class="stat-panel-clean"><p class="text-[10px] text-gray-500 uppercase font-bold mb-1">Play Count</p><h4 class="text-base font-bold text-white">${Utils.formatNumber(u.play_count)}</h4></div>
                    <div class="stat-panel-clean"><p class="text-[10px] text-gray-500 uppercase font-bold mb-1">Total Hits</p><h4 class="text-base font-bold text-white">${Utils.formatNumber(u.total_hits)}</h4></div>
                    <div class="stat-panel-clean"><p class="text-[10px] text-gray-500 uppercase font-bold mb-1">Max Combo</p><h4 class="text-base font-bold text-white">${Utils.formatNumber(u.max_combo)}x</h4></div>
                    ...
                    <div class="stat-panel-clean"><p class="text-[10px] text-gray-500 uppercase font-bold mb-1">Replays</p><h4 class="text-base font-bold text-white">${Utils.formatNumber(u.replays_watched)}</h4></div>
        ...
        loadRecentActivity();
    } catch(e) { c.innerHTML = '<div class="col-span-4 text-center text-xs text-red-400 py-4">Failed to load stats</div>'; }
}
